    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
      ...
      <motion.section variants={itemVariants}>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          {/* Center card for the 7th domain */}
          {domains.length >= 7 && (
            <motion.div
              variants={itemVariants}
              className="md:col-span-2 lg:col-span-1 lg:col-start-2 bg-white rounded-lg shadow-lg p-6 cursor-pointer hover:shadow-xl transition-shadow"
